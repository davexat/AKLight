...
docker stop aklight-broker aklight-producer1 aklight-producer2 2>nul

REM Eliminar contenedores
docker rm aklight-broker aklight-producer1 aklight-producer2 2>nul
...
if /i "%REPLY%"=="s" (
    docker rmi aklight-broker aklight-producer 2>nul
